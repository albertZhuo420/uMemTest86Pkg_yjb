...
[Defines]
  PLATFORM_NAME                  = MemTest86-site-trial
  PLATFORM_GUID                  = 2CFC3A35-F4A7-49B1-9FBC-81504BE5AE14
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/MemTest86-site-trial
  SUPPORTED_ARCHITECTURES        = IA32|IPF|X64|EBC|AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT

[BuildOptions.Common]
  MSFT:*_*_*_CC_FLAGS    = /D SITE_EDITION /D TRIAL
  MSFT:*_*_*_DLINK_FLAGS	=	/ALIGN:4096
  GCC:*_*_*_CC_FLAGS     = -DSITE_EDITION -DTRIAL
...
[Components.common]
  uMemTest86Pkg/uMemTest86SiteTrial.inf {
#    <PcdsFixedAtBuild>
