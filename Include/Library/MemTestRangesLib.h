...
//
//Description:
//	Memory range enumerating function declarations
//
//
//References:
...
/**
  Checks whether a memory range is locked

  @param[in]    Start   Start of the memory range
  @param[in]    Length  Length of the memory range

  @retval  TRUE                   The range is locked
  @retval  BOOLEAN                The range is unlocked
